...
class image_recognition:
    ...
    def __init__(self,print_status=True, write_images=False,
                 image_Path=r"C:\Users\pooja\Desktop\Captures",testing_Path=r"C:\Users\pooja\Desktop\Captures",
    ...
    def test_objectDetect(self,bgFile,targetFile):
        ...
        print(self.TESTDIR+bgFile+".jpg")
        bg=cv2.imread(self.TESTDIR+targetFile+".jpg")
        print(bg)

        obj_count, detected_points, img_output=self.run_detection(img,bg,True)
        self.detectionOutput(img, obj_count, detected_points, img_output)
...
imageRec = image_recognition(
    print_status=True,           # Print status messages
    write_images=False,          # Do not write images to disk
    image_Path="C:/Users/pooja/Desktop/Captures/" ,    
    testing_Path="C:/Users/pooja/Desktop/Captures/",   
    preview_images=False,        # Do not preview images
    preview_autoclose=True,      # Automatically close preview images
    print_img_labels=True        # Print image labels
)

#bg_image = imageRec.readImage("undst_bg.jpg")
#target_image = imageRec.readImage("undst_cam.jpg")

# Run object detection
#obj_count, detected_points, img_output = imageRec.run_detection(target_image, bg_image)
...
#imageRec.detectionOutput(target_image, obj_count, detected_points, img_output)

# Optionally, you can save the output image to a file
#imageRec.writeImage("output.jpg", img_output, testdir=True)
